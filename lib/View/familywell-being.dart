...
class FamilyWellBeing extends StatefulWidget {
  const FamilyWellBeing({super.key});

  @override
  State<FamilyWellBeing> createState() => _FamilyWellBeingState();
}

class _FamilyWellBeingState extends State<FamilyWellBeing> {
  @override
        ...
        child: mobile
            ? Column(children: [
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/familyimage.png"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
                ...
                Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Container(
                        color: BoxColor
                            .family, // Assuming kbluebox is a predefined color
                        padding: const EdgeInsets.all(
                            8.0), // Adds padding inside the text container
                        child: Text(
                          "BOOK YOUR NUTRITION DINING",
                          textAlign: TextAlign
                              .center, // Centers the text inside the container
                          style: TextStyle(
                            color: CardColor.family, // Text color
                            fontSize: width > 600
                                ? 24
                                : 12, // Text size, adjust as needed
                          ),
