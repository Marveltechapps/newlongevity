...
class NaturoPAthy extends StatelessWidget {
  const NaturoPAthy({super.key});
        ...
        child: mobile
            ? Column(children: [
                    ...
                    Container(
                      ...
                      decoration: const BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage("assets/naturobanner.png"),
                          fit: BoxFit.fill,
                        ),
                      ),
                    ),
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/naturoimage.png"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
                ...
                const Padding(
                  ...
                  child: Text(
                    'Naturopathy is a healing technique that uses the healing powers of nature. Naturopathy works on the principle that, ‘the accumulation of toxins is the root cause of all diseases. Hence prevention of such accumulation, and elimination of existing toxins is the definitive route to sustained health and wellbeing.',
                ...
                const Padding(
                  padding: EdgeInsets.all(10.0),
                  child: Text(
                    'This multi-disciplinary approach uses the healing power of natural resources like foods, herbs, earth, water, air, sun and even magnets, to allow the body heal itself.',
                    style: TextStyle(height: 1.75),
                    textAlign: TextAlign.justify,
                  ),
                ),
                ...
                Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Container(
                        color: CardColor
                            .naturopathy, // Assuming kbluebox is a predefined color
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            color: BoxColor.naturopathy, // Text color
                            fontSize: width > 600
                                ? 24
