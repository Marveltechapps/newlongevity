...
class PersonalWellBeing extends StatefulWidget {
  const PersonalWellBeing({super.key});

  @override
  State<PersonalWellBeing> createState() => _PersonalWellBeingState();
}

class _PersonalWellBeingState extends State<PersonalWellBeing> {
  @override
        ...
        child: mobile
            ? Column(children: [
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/personalimage.png"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
                ...
                Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Container(
                        color: BoxColor
                            .personal, // Assuming kbluebox is a predefined color
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            color: BoxColor.personal, // Text color
                            fontSize: width > 600
                                ? 24
